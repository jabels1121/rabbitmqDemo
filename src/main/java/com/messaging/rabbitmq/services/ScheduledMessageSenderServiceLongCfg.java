...
@Profile("longCfg")
@Service
public class ScheduledMessageSenderServiceLongCfg implements ScheduledMessageSenderService {

    private static final Logger log = LoggerFactory.getLogger(ScheduledMessageSenderServiceLongCfg.class);
    ...
    public ScheduledMessageSenderServiceLongCfg(MessageProducer messageProducer,
